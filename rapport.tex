...
\begin{example}
    $13 \perp 8 \implies {[(13, 8)]}_{21} \in \JS$
\end{example}
\begin{figure}[h]
...
\begin{proposition}
    Soit $a, b \in \mathbb{Z}$
    \[ 
        {[(a, b)]}_n \in \JS \implies
        \forall k \in \mathbb{Z}^*: {[(a, b)]}_{n+kab} \in \JS
    \]
\end{proposition}
